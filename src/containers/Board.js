    ...
    return (
      <div>
        ...
        <ul className="right" id="foots">
          { wrongGuessCount(this.props.word, this.props.guesses) === 5 ?
            (<img src="https://imageshack.com/a/img923/8052/A8U1Ew.gif" alt="foot"/>) : ''
          }
        </ul>

        <ul className="left" id="whole">
          { wrongGuessCount(this.props.word, this.props.guesses) === 6 ?
            (<img src="https://imagizer.imageshack.com/v2/1024x768q90/923/x5uF2K.jpg" alt="foot"/>) : ''
          }
        </ul>
      </div>
    )
